...
import { Activity, Users, TriangleAlert, PackageOpen, LayoutDashboard, ShoppingCart, Banknote, HeartPulse } from 'lucide-react';
...
const Widget = ({ title, value, subValue, icon: Icon, color, onClick }: WidgetProps) => (
  <div 
    onClick={onClick}
    style={{ 
  ...
  >
    <div style={{ position: 'relative', zIndex: 1 }}>
      ...
      <h2 style={{ fontSize: '36px', fontWeight: '800', color: 'var(--text-h)', margin: 0, letterSpacing: '-1px' }}>{value}</h2>
...
export function Dashboard() {
  ...
  return (
    <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
        ...
        <div style={{ position: 'relative', zIndex: 1, display: 'flex', alignItems: 'center', width: '100%' }}>
          ...
          <div>
            ...
            <p style={{ color: '#94a3b8', margin: 0, marginTop: '0.4rem', fontSize: '16px', fontWeight: '500' }}>
              Te presentamos el resumen operativo de <span style={{ color: '#60a5fa', fontWeight: '700' }}>Marakame</span> para hoy.
            </p>
          </div>
      ...
      {(esAdmin || esMedico) && (
        <>
          <h3 style={{ fontSize: '18px', color: '#4a5568', marginBottom: '1rem', display: 'flex', alignItems: 'center' }}>
            <HeartPulse size={20} style={{ marginRight: '0.5rem' }}/> Estado de la Clínica
          </h3>
      ...
      {(esAdmin || esOperativo) && (
        <>
          <h3 style={{ fontSize: '18px', color: '#4a5568', marginBottom: '1rem', display: 'flex', alignItems: 'center' }}>
            <TriangleAlert size={20} style={{ marginRight: '0.5rem' }}/> Alertas Operativas y Administrativas
          </h3>
