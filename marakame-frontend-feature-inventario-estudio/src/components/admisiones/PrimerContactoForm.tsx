...
export const PrimerContactoForm: React.FC = () => {
  ...
  return (
    <form onSubmit={handleSubmit} style={{ maxWidth: '960px', margin: '0 auto', paddingBottom: '4rem' }}>
      ...
      {/* SECCIÓN 7: CIERRE MÉDICO — eliminada del flujo de Admisiones.
          El diagnóstico lo realiza el Área Médica de forma independiente.
          Los campos medicoValoro y conclusionMedica se capturan en la ValoracionDiagnostica. */}
      ...
      <div style={{ marginTop: '2.5rem', display: 'flex', justifyContent: 'flex-end', gap: '1rem' }}>
        ...
        >
          {isSubmitting ? 'Guardando...' : <><ArrowRightCircle size={20} /> Finalizar Registro y Generar Documentación</>}
        </button>
      </div>
